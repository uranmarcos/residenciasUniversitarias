...
<form method="POST" class="row rowAside" action="inicio.php">
    <div class="col-12 colBotonesAside" id="columnaBotonesAside">
        ...
        <button name="perfil" class="asideButton" disabled id="btnPerfil" onmouseover="alert('sección en construcción')" data-toggle="tooltip" data-placement="bottom" title="Mi perfil (en construcción)" onclick="activarBoton('perfil', 'perfilSeccion')">
