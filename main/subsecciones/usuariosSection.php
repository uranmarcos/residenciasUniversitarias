<div class="d-flex anchoTotal justify-content-between">
    ...
    <div class="botonNew" id="botonNewUser" onclick="botonNewUser('cajaNewUser', 'botonNewUser', 'tableUsuarios', 'subtitleUser', 'Crear Usuario')">
        Crear
    </div> 
</div>
<!-- CAJA NUEVO USUARIO -->
    ...
    <form method="POST" action="inicio.php">
        <div class="row anchoTotal">
            ...
            <div class="row rowConfirmar justify-content-around">
                <div onclick="cancelarNewUser('cajaNewUser','errorNewUser', 'botonNewUser', 'campoFormNewUser', 'tableUsuarios', 'subtitleUser', 'Usuarios existentes')" class="botonNew">Cancelar</div>
...
<div class="confirmacionNewUser <?php echo $cajaMensajeConfirmacion ?>">
        ...
        <tbody>
            <?php foreach($usuarios as $usuario){ ?>
                <tr>
                    ...
                    <td class="editButton" onclick="editarUsuario('cajaNewUser', 'tableUsuarios', 'subtitleUser', 'Editar usuario')">
