<div class="d-flex anchoTotal justify-content-between">
    ...
    <div class="botonNew" id="botonNewUser" onclick="botonNewUser('cajaNewUser', 'botonNewUser', 'tableUsuarios')">
        Crear
    </div> 
</div>
<!-- CAJA NUEVO USUARIO -->
    ...
    <form method="POST" action="inicio.php">
        <div class="row anchoTotal">
            ...
            <div class="row rowConfirmar justify-content-around">
                <div onclick="cancelarNewUser('cajaNewUser','errorNewUser', 'botonNewUser', 'campoFormNewUser', 'tableUsuarios')" class="botonNew">Cancelar</div>
