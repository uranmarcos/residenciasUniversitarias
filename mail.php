...
$the_subject = "Nuevo pedido de ". utf8_decode($sedePedido);
$address_to = "marcos_uran@hotmail.com";
//$address_to = "manuel@fundacionsi.org.ar";
$from_name = "Residencia: " . utf8_decode($sedePedido);
...
$phpmailer->Body .="<p>Nuevo pedido de " . utf8_decode($sedePedido ."</p>");
