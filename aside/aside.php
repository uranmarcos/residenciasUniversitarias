...
<form method="POST" class="row rowAside" action="inicio.php">
    <div class="col-10 colBotonesAside" id="columnaBotonesAside">
        ...
        <button name="iniciarPedido" class="asideButton" id="pedido" onclick="resetStorage()" data-toggle="tooltip" data-placement="bottom" title="Nuevo pedido" onclick="activarBoton('pedido', 'pedidoSeccion')">
