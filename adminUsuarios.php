                                ...
                                <div class="modal-footer">
                                    ...
                                    <div class="col-12  hide" id="confirmacionEdicion">
                                        ...
                                        <div class="d-flex align-items-center justify-content-around">
                                            ...
                                            <button type="submit" name="editarUsuario" id="btnEdicion" onclick="desbloquearFormularioEdicion(), mostrarSpinner('btnEdicion','spinnerEditarUsuario')" class="btn boton">Confirmar</button>
