                        ...
                        <tbody>
                            <?php foreach($sedes as $sede){ ?>
                                <tr>
                                    ...
                                    <td>
                                        <button type="button" class="btn editButton" onclick="mostrarCaja('boxEditarSede'), cargarDatosEdicion('<?php echo $sede['id']?>', '<?php echo $sede['descripcion']?>', '<?php echo $sede['casas']?>', <?php echo $sede['habilitado']?>)">
